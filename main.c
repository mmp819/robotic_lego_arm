...
/**
 * @brief Controla los leds del brick. Estos se establecen en color breve durante un funcionamiento
...
/**
 * @brief Reportero sencillo de informacion. Imprime por pantalla el titulo del progrma, una
